...
def TestFunc(path):
    pd_id           = "134666"     #用户中心页可以查询到pd信息
    pd_key          = "WaHn+kqpiUZwwhSfJ9lqvqxJFCRstl7R"
    app_id          = "334666"     #开发者分成用的账号，在开发者中心可以查询到
    app_key         = "TVJx74Szq7vXy1uI7LmHNCkP0gijBy0z"
    #识别类型，
   ...
   #balance 		= api.QueryBalcExtend()   # 直接返余额
    ...
    # 通过文件形式识别：
    # file_name       = os.getcwd().split("common")[0]+"\\t.png"
    file_name = path
...
if __name__ == "__main__":
   ...
   # print(r)
   print(os.getcwd())
   print(os.getcwd().split("common")[0]+"pic.png")
